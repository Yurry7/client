...
CREATE TABLE Chroma (Id INTEGER PRIMARY KEY, Value TEXT);
...
CREATE TABLE GpoPort (Id INTEGER PRIMARY KEY, RisingEdge INTEGER, PulseLengthMillis INTEGER);
CREATE TABLE Library (Id INTEGER PRIMARY KEY, Name TEXT, DeviceId INTEGER, TypeId INTEGER, ThumbnailId INTEGER, Timecode TEXT);
CREATE TABLE OpenRecent (Id INTEGER PRIMARY KEY, Value VARCHAR(255) UNIQUE);
CREATE TABLE Preset (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE Thumbnail (Id INTEGER PRIMARY KEY, Data TEXT, Timestamp TEXT, Size TEXT);
CREATE TABLE Transition (Id INTEGER PRIMARY KEY, Value TEXT);
CREATE TABLE Tween (Id INTEGER PRIMARY KEY, Value TEXT);
CREATE TABLE Type (Id INTEGER PRIMARY KEY, Value TEXT);
CREATE TABLE OscOutput (Id INTEGER PRIMARY KEY, Name TEXT, Address TEXT, Port INTEGER, Description TEXT);
CREATE TABLE AtemDevice (Id INTEGER PRIMARY KEY, Name TEXT, Address TEXT, Description TEXT);
CREATE TABLE AtemSwitcher (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemStep (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemMixerStep (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemAutoTransition (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemKeyer (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemVideoFormat (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE AtemAudioInputState (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT);
CREATE TABLE TriCasterProduct (Id INTEGER PRIMARY KEY, Name TEXT);
CREATE TABLE TriCasterDevice (Id INTEGER PRIMARY KEY, Name TEXT, Address TEXT, Port INTEGER, Description TEXT);
CREATE TABLE TriCasterStep (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterInput (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterAutoSpeed (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterAutoTransition (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterPreset (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterSource (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterSwitcher (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
CREATE TABLE TriCasterNetworkTarget (Id INTEGER PRIMARY KEY, Name TEXT, Value TEXT, Products TEXT);
...
INSERT INTO Configuration (Name, Value) VALUES('OscMonitorPort', '6250');
INSERT INTO Configuration (Name, Value) VALUES('OscControlPort', '3250');
...
INSERT INTO Configuration (Name, Value) VALUES('OpenRecent', '10');
INSERT INTO Configuration (Name, Value) VALUES('DatabaseVersion', '216');
